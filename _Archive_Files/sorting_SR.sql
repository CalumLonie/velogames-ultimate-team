...
# Load the data.
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Tirreno_Adriatico.csv'
INTO TABLE input
...
UNION ALL
	SELECT * FROM output
    INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Tirreno_Adriatico.txt'
	FIELDS TERMINATED BY ',' ENCLOSED BY ''
	LINES STARTING BY '' TERMINATED BY '\n';